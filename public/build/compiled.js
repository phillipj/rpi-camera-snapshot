	...
	if (_p0.ctor === 'Just') {
		...
		return A2(
			_elm_lang$html$Html$img,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src(_p0._0.src),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'});
				...
				if (_p4._0.ctor === 'Ok') {
					return {
						...
						_0: A4(
							_user$project$Main$Model,
							model.lastPhoto,
							_user$project$Main$toMaybePhotos(_p4._0._0),
							model.state,
							_user$project$Main$Fetched),
						_1: _elm_lang$core$Platform_Cmd$none
					};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"CapturePhoto":[],"FetchHistoricalPhotos":[],"NewPhoto":["Result.Result Http.Error String"],"HistoricalPhotos":["Result.Result Http.Error (List Main.Photo)"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Main.Photo":{"args":[],"type":"{ src : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
